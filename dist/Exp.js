            ...
            this.sdk = function (_) {
                if (settings.context !== undefined) {
                    if (settings.context.sdk !== undefined) {
                        ...
                        if (_this2.sentry.use && settings.context.sdk._) {
            ...
            this.context = function (_) {
                if (settings.context !== undefined) {
                    if (settings.context.data !== undefined) {
                        ...
                        if (_this2.sentry.use && settings.context.data.banner_id && settings.context.data.banner_name) {
                ...
                if (this.scoped) {
                    ...
                    rules.forEach(function (rule) {
                        ...
                        if (rule instanceof CSSMediaRule) {
                            var conditionText = void 0;
                            if (!rule.conditionText) {
                                conditionText = '';
                                var condTxtArr = Object.keys(rule.media).map(function (objectKey, index) {
